...
class Fight extends Phaser.Scene {
    ...
    create(){
        ...
        for (var h of heroList){
            let newHero = heroFactory.createFighter(h, 
                                                    i, 
                                                    this.heroSprites[i-1],
                                                    listSelectedHeroes[i-1].potionName,//hero.equipedPotion
                                                    listSelectedHeroes[i-1].potionQte) //hero.equipedPotionStock
